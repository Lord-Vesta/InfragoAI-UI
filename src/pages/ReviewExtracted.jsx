...
const ReviewExtracted = ({ loggedIn, height = "85vh" }) => {
  ...
  useEffect(() => {
    ...
    "data": [
        {
            ...
            "field_value": "Watershed Development of Sabarmati River Banks with waterbody from Narmada main canal to 500m D/S of PDPU Bridge, Ta.- Dist.- Gandhinagar. (Phase - 4, Part - 1)",
        ...
        },
        {
            ...
            "field_value": "Narmada, Water Resources, Water Supply and Kalpsar Department",
            "confidence_score": "1.0000",
            "source_page_number": 1,
            "is_edited": false,
            "edited_value": null,
        ...
        },
        {
            ...
            "field_value": "If the Contract Price offered by the Selected Bidder is lower than 10% but up to 20% of the Estimated Project Cost, then the Additional Performance Security shall be calculated @ 20% of the difference in the Estimated Project Cost and Contract Price offered by the selected Bidder.",
            "confidence_score": "1.0000",
            "source_page_number": 29,
            "is_edited": false,
            "edited_value": null,
        ...
        },
        {
            ...
            "field_value": "The work Similar Project means Dam/Barrage/Aqueduct/Canal Syphon/Bridge over River/River Front Development (like Diaphragm Wall & Retaining Wall) /Marine Works etc. work done under government/semi government department.",
            "confidence_score": "1.0000",
            "source_page_number": 11,
            "is_edited": false,
            "edited_value": null,
        ...
        },
        {
            "extraction_id": 28,
            "field_key": "JV Policy",
            "field_value": "Joint Ventures must comply with the following requirement: The lead partner shall meet not less than 50 percent of all criteria given in para 4.5.3 & 4.5.6 above. The joint venture must collectively satisfy the criteria of para 4.5.3 & 4.5.6 above.",
            "confidence_score": "1.0000",
    ...
    "pdf_file": {
        ...
        "file_size": 1763654,
        "file_exists": true,
        "download_url": "http://informingly-cormous-oscar.ngrok-free.dev/media/pdfs/9876543210_01 Vol-1 SBD.pdf"
    }
}
        ...
        const apiData = fieldConfig.map((config) => {
          ...
          let value = match ? match.field_value : config.type === "toggle" ? "No" : "";

          if (match && config.type === "date" && /^\d{2}\/\d{2}\/\d{4}$/.test(match.field_value)) {
 ...
 const handleBlur = (index) => {
  ...
  console.log("dis", displayedFields)
  return loading ? (
    <Box
      width="100%"
      height={height}
            ...
            <>
              ...
              <Box display="flex" alignItems="center" mb={1}>
                ...
                <Box display="flex" gap={2} alignItems="center">
                  ...
                  {(!field.value || field.value === "" || field.value === "Not found in document") && (
                    <AlertTooltip title="No value found for particular label in document" type="error">
                      <ErrorOutlineIcon style={{ color: "red", fontSize: 18, cursor: "pointer" }} />
                    </AlertTooltip>
                  )}
                </Box>
              </Box>
