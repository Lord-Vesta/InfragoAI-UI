...
//   console.log("apiRes",apiResponseData)
...
//       setStatus(response?.final_qualification);
...
const QualificationResult = () => {
  ...
  const qualifications = apiData
    ? [
        {
          name: "Technical Qualification",
          status: apiData.technical_qualification.status,
          // reason: apiData.technical_qualification.reason,
          met: apiData.technical_qualification.status === "Fully Met",
        },
        {
          name: "Financial Qualification",
          status: apiData.financial_qualification.status,
          // reason: apiData.financial_qualification.reason,
          met: apiData.financial_qualification.status === "Fully Met",
        },
      ]
    : [];
            ...
            <Box sx={{ p: 3, pb: 5 }}>
              ...
              >
                {qualifications.map((q, index) => (
                  <Grid item key={index} sx={{ flex: "0 0 300px" }}>
                    <QualificationBox
                      title={q.name}
                      status={q.status}
                      // reason={q.reason}
          ...
          >
            ...
            >
              ...
              >
                ...
                qualification or securing additional financial backing,
                Infravgo’s Facilitation Network can connect you to the right
                partners — quickly, confidentially, and with full guidance till
                approval.
              </Typography>
              <Button
                variant="contained"
